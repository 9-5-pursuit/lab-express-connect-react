...
function CreateLog() {
  ...
  return (
    <form onSubmit={(e) => handleOnSubmit(e)}>
        ...
        <input type="text" value={log?.captainName} onChange={(e) => setLog({ ...log, captainName: e.target.value})}required />
        <br />
        <label>Title</label>
        <input type="text" value={log?.title} onChange={(e) => setLog({ ...log, title: e.target.value})} required
        />
        <br />
        <label>Post:</label>
        ...
        <input type="checkbox" value={log.mistakesWereMadeToday} onChange={(e) => setLog({ ...log,mistakesWereMadeToday: e.target.value})}/>
